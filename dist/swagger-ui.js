...
function program12(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n\n  ";
  stack1 = helpers['if'].call(depth0, depth0.help, {hash:{},inverse:self.noop,fn:self.program(8, program8, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  buffer += escapeExpression(stack1)
    + "\n    ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.info),stack1 == null || stack1 === false ? stack1 : stack1.version), {hash:{},inverse:self.noop,fn:self.program(10, program10, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "]\n    ";
  stack2 = helpers['if'].call(depth0, depth0.validatorUrl, {hash:{},inverse:self.noop,fn:self.program(12, program12, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n    </h4>\n    </div>\n</div>\n";
  return buffer;
  });
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.showStatus = function(response) {
      var code, content, contentType, e, headers, jobStatus, json, opts, pre, reqStatus, response_body, response_body_el, url;
    ...
    OperationView.prototype.jobStatus = function(e) {
      var headerParams, obj, param, _i, _len, _ref5,
        _this = this;
      if (e != null) {
        e.preventDefault();
      }
